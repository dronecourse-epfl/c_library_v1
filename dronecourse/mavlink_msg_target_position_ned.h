...
#define MAVLINK_MSG_ID_TARGET_POSITION_NED_CRC 12
#define MAVLINK_MSG_ID_150_CRC 12
...
#define MAVLINK_MESSAGE_INFO_TARGET_POSITION_NED { \
	...
	{  { "x", NULL, MAVLINK_TYPE_FLOAT, 0, 0, offsetof(mavlink_target_position_ned_t, x) }, \
         ...
         { "vx", NULL, MAVLINK_TYPE_FLOAT, 0, 12, offsetof(mavlink_target_position_ned_t, vx) }, \
         { "vy", NULL, MAVLINK_TYPE_FLOAT, 0, 16, offsetof(mavlink_target_position_ned_t, vy) }, \
         { "vz", NULL, MAVLINK_TYPE_FLOAT, 0, 20, offsetof(mavlink_target_position_ned_t, vz) }, \
...
{
	return mavlink_msg_target_position_ned_pack(system_id, component_id, msg, target_position_ned->x, target_position_ned->y, target_position_ned->z, target_position_ned->vx, target_position_ned->vy, target_position_ned->vz, target_position_ned->target_num);
}
...
{
	return mavlink_msg_target_position_ned_pack_chan(system_id, component_id, chan, msg, target_position_ned->x, target_position_ned->y, target_position_ned->z, target_position_ned->vx, target_position_ned->vy, target_position_ned->vz, target_position_ned->target_num);
}
...
static inline void mavlink_msg_target_position_ned_send(mavlink_channel_t chan, float x, float y, float z, float vx, float vy, float vz, uint8_t target_num)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_TARGET_POSITION_NED_LEN];
	_mav_put_float(buf, 0, x);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_target_position_ned_send(chan, target_position_ned->x, target_position_ned->y, target_position_ned->z, target_position_ned->vx, target_position_ned->vy, target_position_ned->vz, target_position_ned->target_num);
#else
 ...
 */
static inline void mavlink_msg_target_position_ned_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  float x, float y, float z, float vx, float vy, float vz, uint8_t target_num)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field vx from target_position_ned message
 *
 * @return X velocity in NED frame in meter / s
 */
static inline float mavlink_msg_target_position_ned_get_vx(const mavlink_message_t* msg)
{
	return _MAV_RETURN_float(msg,  12);
}

/**
 * @brief Get field vy from target_position_ned message
 *
 * @return Y velocity in NED frame in meter / s
 */
static inline float mavlink_msg_target_position_ned_get_vy(const mavlink_message_t* msg)
{
	return _MAV_RETURN_float(msg,  16);
}

/**
 * @brief Get field vz from target_position_ned message
 *
 * @return Z velocity in NED frame in meter / s
 */
static inline float mavlink_msg_target_position_ned_get_vz(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_target_position_ned_decode(const mavlink_message_t* msg, mavlink_target_position_ned_t* target_position_ned)
{
	...
	target_position_ned->vx = mavlink_msg_target_position_ned_get_vx(msg);
	target_position_ned->vy = mavlink_msg_target_position_ned_get_vy(msg);
	target_position_ned->vz = mavlink_msg_target_position_ned_get_vz(msg);
